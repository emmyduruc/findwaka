        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-textMuted mb-12 max-w-2xl mx-auto">
              Connecting rural communities with reliable transportation. Find bikes, tricycles, and cars near you instantly.
            </p>
          ...
          >
            {[
              { image: '/images/okada.png', label: 'Bikes', color: 'from-accentPrimary to-cyan-500' },
              { image: '/images/keke.png', label: 'Tricycles', color: 'from-accentSecondary to-purple-500' },
              { image: '/images/car.png', label: 'Cars', color: 'from-success to-emerald-500' },
            ].map((vehicle, index) => (
              <motion.div
                key={vehicle.label}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-textMuted leading-relaxed">
              ...
              No more walking long distances to find transportation. With WakaJor, 
              you can see available drivers online, pick the one you want, and connect 
              with them instantly via call, WhatsApp, or our in-app chat.
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              {
                title: 'Find a Driver',
                desc: 'Browse through verified drivers in your area. See their vehicle type, ratings, and distance from you.',
                icon: MapPin,
              },
              {
                title: 'Switch to Driver',
                desc: 'Are you a passenger? Switch to become a driver and start earning. The choice is yours.',
                icon: ArrowRight,
              },
            ].map((feature, index) => (
              <motion.div
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Tricycle Leasing', image: '/images/keke.png' },
              { title: 'Car Leasing', image: '/images/car.png' },
              { title: 'Bike Leasing', image: '/images/okada.png' },
            ].map((item, index) => (
              <motion.div
                key={item.title}
                initial={{ opacity: 0, scale: 0.8 }}
